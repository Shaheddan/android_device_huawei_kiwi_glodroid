...
# kiwi: fingerprint (route A). Declares the hidl interface, without which
# the framework never looks for the service.
DEVICE_MANIFEST_FILE += $(BC_PATH)/fingerprint/android.hardware.biometrics.fingerprint@2.1.xml
...
KERNEL_FRAGMENTS := $(BOARD_KERNEL_SRC_DIR)/kernel/configs/android.config \
		    ...
		    $(BC_PATH)/kernel-fragments/kiwi_qseecom.config \
